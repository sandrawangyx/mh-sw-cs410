...
WELCOME_MSG = "Welcome to Smart Movies. You can say, play the audio to begin the podcast."
...
HELP_DURING_PLAY_MSG = "You are listening to Smart Movies. You can say, Next or Previous to navigate through the playlist. At any time, you can say Pause to pause the audio and Resume to resume."
STOP_MSG = "Goodbye."
...
DYNAMODB_TABLE_NAME = "smart-movies"
