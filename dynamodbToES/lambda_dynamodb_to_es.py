...
ES_ENDPOINT = os.environ['elasticsearch_domain_name']
...
def post_to_es(payload):
   ...
   es_url = urllib.parse.urlparse(ES_ENDPOINT)
...
def _lambda_handler(event, context):
   ...
   for record in records:
       ...
       doc_table = 'hundredkds'  # Use formatter
       doc_type = ddb_table_name.lower()   # Use formatter
       ...
       if (event_name == 'INSERT') or (event_name == 'MODIFY'):
           ...
           if doc_type == "users": 
               del doc_fields["id"]
               doc_fields["zip code"] = doc_fields["zip"]
               del doc_fields["zip"]
           if doc_type == "ratings":
               doc_fields["movieid"] = doc_fields["movieId"]
               doc_fields["userid"] = doc_fields["userId"]
               del doc_fields["movieId"]
               del doc_fields["userId"]
